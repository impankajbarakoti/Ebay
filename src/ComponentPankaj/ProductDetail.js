...
const ProductDetails = () => {
  ...
  if (!product) {
    return <p className="text-center text-red-600 text-xl">Product not found!</p>;
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-8">
      <h1 className="text-3xl font-bold mb-6 text-blue-800 text-center">Product Details</h1>
